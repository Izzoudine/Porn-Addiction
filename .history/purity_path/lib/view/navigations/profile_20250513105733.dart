              ...
              child: Column(
                children: [
                  ...
                  if (_hasStartedJourney) ...[
                      ...
                      child: Column(
                        children: [
                          _buildInfoRow(
                            ...
                            value: _formatDate(_lastRelapseDate),
                          ),
                          const Divider(),
                          _buildInfoRow(
                            icon: Icons.calendar_month,
                            title: "Compte créé le",
                            value: _formatDate(_accountCreationDate),
                          ),
                    ...
                    // Message si le parcours n'a pas commencé
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text(
                            "Commencez votre parcours sur la page d'accueil pour voir vos statistiques ici.",
