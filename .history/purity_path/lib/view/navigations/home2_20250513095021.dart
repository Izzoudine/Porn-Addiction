                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  List<List<Color>> colorSchemes = [
                                    [const Color(0xFF2196F3), const Color(0xFF1976D2)], // Blue scheme
                                    [const Color(0xFF42A5F5), const Color(0xFF1E88E5)], // Lighter blue
                                    [const Color(0xFF64B5F6), const Color(0xFF2979FF)], // Even lighter blue
                                  ];
                              ...
                              children: [
                                ...
                                ...List.generate(
                                  ...
                                  (index) => Container(
                                    ...
                                    decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      color: contentIndex == index ? const Color(0xFF2196F3) : Colors.grey.shade300,
                                    ),
                                  ),
                                ),
                                IconButton(
